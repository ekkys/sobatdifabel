    ...
    <body>
        ...
        <!-- Root Container -->
		 ...
		 <div id="wrapper" class="wrapper">
                ...
                <div id="content">
                    <div id="intro">
                        <h1><span>Layanan Konsultasi</span></h1>
                        <p style="text-align: center;">
						Layanan yang disediakan oleh sobat difabel dengan memberikan saran atau rekomendasi kepada user atau pihak pihak terkait mengenai hak-hak dasar yang dibutuhkan dan pengetahuan lebih mendalam terkait inklusifitas , serta memberikan rehabilitasi psikis bagi user yang membutuhkan. Berdasarkan pengalaman dan ilmu pengetahuan konsultan.
                       </p>
