            ...
            <div id="content">
                <div id="intro">
                    ...
                    <p style="text-align: center;">
                        <p>Kemajuan teknologi sepatutnya dimanfaatkan untuk menghubungkan berbagai stakeholder menuju lingkungan yang inklusif. Sobat difabel yang berarti Semua Orang BAnTu hadir melalui platform teknologi yang menyediakan berbagai layanan yang bertujuan mewujudkan lingkungan yang ramah difabel melalui program-program yang mempermudah difabel untuk mengakses aktivitas publik. Dalam merealisasikan tujuan tersebut sobat difabel mengintegrasikan berbagai elemen masyarakat melalui edukasi dan pengembangan teknologi sehingga menghasilkan inovasi teknologi pelayanan bagi difabel maupun non-difabel.</p>
                    </p>
                </div>
