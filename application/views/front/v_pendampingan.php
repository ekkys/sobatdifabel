       ...
       <img src="<?php echo base_url() . 'assets/images/bg1.jpg' ?>" class="bg" alt="" />
        ...
        <!-- Root Container -->
		 ...
		 <div id="wrapper" class="wrapper">
                ...
                <div id="content">
                    <div id="intro">
                        <h1><span>Layanan Pendampingan</span></h1>
                        <p style="text-align: center;">
						Layanan yang disediakan untuk mengupayakan perlakuan fasilitas bagi difabel agar tercapainya partisipasi penuh dalam masyarakat disegala aspek kehidupan.  </p>
						<p>Ragam Sobat yang akan mendampingi yakni Sobat JBI, Notula/Juru Ketik, Sobat Akses dan Sobat Virtual</p>
