...
<head>
  ...
  <title> Sobat Difabel | Register</title>
...
<body class="hold-transition login-page">
  <div class="login-box">
    <div class="login-logo">
      <a href="<?php echo base_url() ;?>"><b>Register</b> SobatDifabel</a>
    </div>
    <!-- /.login-logo -->
    ...
    <div class="login-box-body">
      <p class="login-box-msg">www.sobatdifabel.com</p>

      <form action="<?php echo base_url('dashboard/blank');?>" method="post">
