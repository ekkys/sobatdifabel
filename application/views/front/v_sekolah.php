    ...
    <body>
        ...
        <!-- Root Container -->
		 ...
		 <div id="wrapper" class="wrapper">
                ...
                <div id="content">
                    <div id="intro">
                        <h1><span>Layanan Sekolah Inklusi Nusantara</span></h1>
                        <p style="text-align: center;">
						Layanan untuk bertukar informasi , tutorial, dan mengedukasi , serta mensosialisasikan isu-isu terkait difabel secara langsung maupun virtual(daring). Tutorial dan edukasi dapat berupa konten Audio, video, tulisan popular, artikel ilmiah, opini, cerita fiksi, cerita bergambar dan fotografi.</p>
					  <p>Selain itu sekolah Inklusi Nusantara akan mendatangi Sekolah, Kampus, serta Perusahaan/Instansi yang berbasis inklusi</p> 
                  </div>
